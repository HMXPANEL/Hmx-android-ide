...
import com.hmxpanel.aiide.templates.base.root.buildGradleSrcGroovy
import com.hmxpanel.aiide.templates.base.root.buildGradleSrcKts
import com.hmxpanel.aiide.templates.base.root.gradleWrapperProps
import com.hmxpanel.aiide.templates.base.root.settingsGradleSrcStr
import com.hmxpanel.aiide.templates.base.util.optonallyKts
import com.hmxpanel.aiide.utils.transferToStream
import java.io.File
...
class ProjectTemplateBuilder :
  ...
  fun baseAsset(path: String) =
    com.hmxpanel.aiide.templates.base.util.baseAsset("root", path)
