...
import com.hmxpanel.aiide.templates.SrcSet
import com.hmxpanel.aiide.templates.TemplateBuilder
import com.hmxpanel.aiide.templates.TemplateRecipeConfigurator
import com.hmxpanel.aiide.templates.TemplateRecipeFinalizer
import com.hmxpanel.aiide.templates.base.models.Dependency
import com.hmxpanel.aiide.templates.base.models.defaultDependency
...
abstract class ModuleTemplateBuilder :
   ...
   * @see com.hmxpanel.aiide.templates.base.baseAsset
   */
  open fun baseAsset(path: String) =
    com.hmxpanel.aiide.templates.base.util.baseAsset("module", path)
   ...
   * [Implementation][com.hmxpanel.aiide.templates.base.models.DependencyConfiguration.Implementation]
   * configuration.
   *
