...
package com.hmxpanel.aiide.uidesigner.adapters
...
import com.hmxpanel.aiide.inflater.IView.SingleAttributeChangeListener
import com.hmxpanel.aiide.uidesigner.R
import com.hmxpanel.aiide.uidesigner.adapters.ViewAttrListAdapter.VH
import com.hmxpanel.aiide.uidesigner.databinding.LayoutViewattrItemBinding
...
internal class ViewAttrListAdapter(
  attributes: List<com.hmxpanel.aiide.inflater.IAttribute>,
  private val viewModel: WorkspaceViewModel?,
  private val onDeleteAttr: (com.hmxpanel.aiide.inflater.IAttribute) -> Boolean,
  private val onClick: (com.hmxpanel.aiide.inflater.IAttribute) -> Unit
