...
package com.hmxpanel.aiide.uidesigner.viewmodel
...
internal class WorkspaceViewModel : ViewModel() {
  ...
  internal val _view = MutableLiveData<com.hmxpanel.aiide.inflater.IView>(null)
  ...
  var view: com.hmxpanel.aiide.inflater.IView?
