...
import com.hmxpanel.aiide.uidesigner.undo.ViewAddedAction
import com.hmxpanel.aiide.uidesigner.undo.ViewMovedAction
import com.hmxpanel.aiide.uidesigner.undo.ViewRemovedAction
...
internal class WorkspaceViewHierarchyHandler :
  ...
  private fun pushAction(view: com.hmxpanel.aiide.inflater.IView,
  ...
  override fun beforeViewAdded(group: IViewGroup,
                               view: com.hmxpanel.aiide.inflater.IView,
                               index: Int
  ) {
    animateLayoutChange()
  }
