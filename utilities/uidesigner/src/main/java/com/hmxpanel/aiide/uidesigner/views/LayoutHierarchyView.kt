...
package com.hmxpanel.aiide.uidesigner.views
...
constructor(
  ...
  private fun addViews(view: IView, depth: Int) {
    ...
    if (view is com.hmxpanel.aiide.inflater.IViewGroup) {
  ...
  private fun computeChildCount(view: com.hmxpanel.aiide.inflater.IViewGroup): Int {
    var count = view.childCount
    view.forEachIndexed { index, child ->
      if (index != view.childCount - 1 && child is com.hmxpanel.aiide.inflater.IViewGroup) {
