...
import com.hmxpanel.aiide.actions.ActionItem.Location.UI_DESIGNER_TOOLBAR
...
import com.hmxpanel.aiide.uidesigner.actions.clearUiDesignerActions
import com.hmxpanel.aiide.uidesigner.actions.registerUiDesignerActions
import com.hmxpanel.aiide.uidesigner.databinding.ActivityUiDesignerBinding
import com.hmxpanel.aiide.uidesigner.fragments.DesignerWorkspaceFragment
import com.hmxpanel.aiide.uidesigner.utils.ViewToXml
...
class UIDesignerActivity : BaseIDEActivity() {
  ...
  fun setupHierarchy(view: com.hmxpanel.aiide.inflater.IView) {
