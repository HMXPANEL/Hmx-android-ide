...
import com.hmxpanel.aiide.templates.ParameterConstraint.CLASS
import com.hmxpanel.aiide.templates.ParameterConstraint.CLASS_NAME
...
import com.hmxpanel.aiide.templates.ParameterConstraint.FILE
import com.hmxpanel.aiide.templates.ParameterConstraint.LAYOUT
...
import com.hmxpanel.aiide.templates.ParameterConstraint.PACKAGE
import com.hmxpanel.aiide.templates.base.util.isValidModuleName
import com.hmxpanel.aiide.templates.base.util.moduleNameToDirName
...
class UtilTest {
  ...
  fun `test constraint verifier`() {
    ConstraintVerifier.apply {
      ...
      assertThat(isValid("com.hmxpanel.aiide", listOf(PACKAGE))).isTrue()
