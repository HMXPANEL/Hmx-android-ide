...
package com.hmxpanel.aiide.inflater.internal
...
import com.hmxpanel.aiide.inflater.DefaultComponentFactory
import com.hmxpanel.aiide.inflater.IAttribute
import com.hmxpanel.aiide.inflater.IComponentFactory
import com.hmxpanel.aiide.inflater.IComponentFactory.Companion.LAYOUT_INFLATER_COMPONENT_FACTORY_KEY
import com.hmxpanel.aiide.inflater.ILayoutInflater
...
import com.hmxpanel.aiide.inflater.InflateException
import com.hmxpanel.aiide.inflater.events.IInflateEventsListener
import com.hmxpanel.aiide.inflater.events.InflationFinishEvent
import com.hmxpanel.aiide.inflater.events.InflationStartEvent
import com.hmxpanel.aiide.inflater.events.OnApplyAttributeEvent
import com.hmxpanel.aiide.inflater.events.OnInflateViewEvent
import com.hmxpanel.aiide.inflater.internal.utils.IDTable
import com.hmxpanel.aiide.inflater.internal.utils.ViewFactory.createViewInstance
import com.hmxpanel.aiide.inflater.internal.utils.ViewFactory.generateLayoutParams
import com.hmxpanel.aiide.inflater.internal.utils.parseLayoutReference
import com.hmxpanel.aiide.inflater.utils.endParse
import com.hmxpanel.aiide.inflater.utils.isParsing
import com.hmxpanel.aiide.inflater.utils.startParse
import com.hmxpanel.aiide.inflater.viewAdapter
import com.hmxpanel.aiide.lookup.Lookup
import com.hmxpanel.aiide.projects.android.AndroidModule
import com.hmxpanel.aiide.xml.widgets.Widget
import com.hmxpanel.aiide.xml.widgets.WidgetTable
import com.hmxpanel.aiide.xml.widgets.WidgetType
import java.io.File
...
open class LayoutInflaterImpl : ILayoutInflater {
  ...
  protected open fun processXmlFile(file: File): Pair<XmlProcessor, AndroidModule> {
    return com.hmxpanel.aiide.inflater.utils.processXmlFile(file, LAYOUT)
  }
  ...
  private fun startInflation(file: File) {
    ...
    if (!isParsing) {
      if (this.module == null) {
        startParse(file)
        this.module = com.hmxpanel.aiide.inflater.utils.module
      } else {
