...
import com.hmxpanel.aiide.inflater.internal.AttributeImpl
 ...
 * - [ViewAdapter][com.hmxpanel.aiide.annotations.inflater.ViewAdapter] is used to specify the
 *   view whose attributes are handled by the view adapter implementation.
 * - [IncludeInDesigner][com.hmxpanel.aiide.annotations.uidesigner.IncludeInDesigner] is used to
...
abstract class IViewAdapter<T : View> : AbstractParser() {
   ...
   * [ViewAdapter][com.hmxpanel.aiide.annotations.inflater.ViewAdapter] annotation.
   *
