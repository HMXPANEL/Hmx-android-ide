...
import com.hmxpanel.aiide.inflater.IViewAdapter
import com.hmxpanel.aiide.inflater.internal.IncludeView
import com.hmxpanel.aiide.inflater.models.UiWidget
import com.hmxpanel.aiide.inflater.utils.newAttribute
...
open class ViewAdapter<T : View> : IViewAdapter<T>() {
  ...
  protected open fun parseDrawingCacheQuality(value: String): Int {
    return com.hmxpanel.aiide.inflater.internal.utils.parseDrawingCacheQuality(value)
  }

  protected open fun parseVisibility(value: String): Int {
    return com.hmxpanel.aiide.inflater.internal.utils.parseVisibility(value)
  }

  protected open fun parseTextAlignment(value: String): Int {
    return com.hmxpanel.aiide.inflater.internal.utils.parseTextAlignment(value)
  }

  protected open fun parseTextDirection(value: String): Int {
    return com.hmxpanel.aiide.inflater.internal.utils.parseTextDirection(value)
  }

  protected open fun parsePorterDuffMode(mode: String): PorterDuff.Mode {
    return com.hmxpanel.aiide.inflater.internal.utils.parsePorterDuffMode(mode)
  }
