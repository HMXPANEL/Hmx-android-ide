...
package com.hmxpanel.aiide.inflater.vectormaster.models;
...
import com.hmxpanel.aiide.inflater.vectormaster.DefaultValues;
import com.hmxpanel.aiide.inflater.vectormaster.utilities.Utils;
import com.hmxpanel.aiide.inflater.vectormaster.utilities.parser.PathParser;
...
public class PathModel {
  ...
  public void buildPath(boolean useLegacyParser) {
    if (useLegacyParser) {
      originalPath =
          com.hmxpanel.aiide.inflater.vectormaster.utilities.legacyparser.PathParser.createPathFromPathData(
              pathData);
    } else {
