...
package com.hmxpanel.aiide.tooling.impl
...
import com.hmxpanel.aiide.tooling.api.messages.GradleDistributionParams
import com.hmxpanel.aiide.tooling.api.messages.GradleDistributionType
import com.hmxpanel.aiide.tooling.api.messages.InitializeProjectParams
import com.hmxpanel.aiide.tooling.api.messages.TaskExecutionMessage
import com.hmxpanel.aiide.tooling.api.messages.result.BuildCancellationRequestResult
import com.hmxpanel.aiide.tooling.api.messages.result.BuildCancellationRequestResult.Reason.CANCELLATION_ERROR
import com.hmxpanel.aiide.tooling.api.messages.result.BuildInfo
import com.hmxpanel.aiide.tooling.api.messages.result.BuildResult
import com.hmxpanel.aiide.tooling.api.messages.result.InitializeResult
import com.hmxpanel.aiide.tooling.api.messages.result.TaskExecutionResult
import com.hmxpanel.aiide.tooling.api.messages.result.TaskExecutionResult.Failure
import com.hmxpanel.aiide.tooling.api.messages.result.TaskExecutionResult.Failure.BUILD_CANCELLED
import com.hmxpanel.aiide.tooling.api.messages.result.TaskExecutionResult.Failure.BUILD_FAILED
import com.hmxpanel.aiide.tooling.api.messages.result.TaskExecutionResult.Failure.CONNECTION_CLOSED
import com.hmxpanel.aiide.tooling.api.messages.result.TaskExecutionResult.Failure.CONNECTION_ERROR
import com.hmxpanel.aiide.tooling.api.messages.result.TaskExecutionResult.Failure.PROJECT_DIRECTORY_INACCESSIBLE
import com.hmxpanel.aiide.tooling.api.messages.result.TaskExecutionResult.Failure.PROJECT_NOT_DIRECTORY
import com.hmxpanel.aiide.tooling.api.messages.result.TaskExecutionResult.Failure.PROJECT_NOT_FOUND
import com.hmxpanel.aiide.tooling.api.messages.result.TaskExecutionResult.Failure.PROJECT_NOT_INITIALIZED
import com.hmxpanel.aiide.tooling.api.messages.result.TaskExecutionResult.Failure.UNKNOWN
import com.hmxpanel.aiide.tooling.api.messages.result.TaskExecutionResult.Failure.UNSUPPORTED_BUILD_ARGUMENT
import com.hmxpanel.aiide.tooling.api.messages.result.TaskExecutionResult.Failure.UNSUPPORTED_CONFIGURATION
import com.hmxpanel.aiide.tooling.api.messages.result.TaskExecutionResult.Failure.UNSUPPORTED_GRADLE_VERSION
import com.hmxpanel.aiide.tooling.api.models.ToolingServerMetadata
import com.hmxpanel.aiide.tooling.impl.internal.ProjectImpl
import com.hmxpanel.aiide.tooling.impl.sync.ModelBuilderException
import com.hmxpanel.aiide.tooling.impl.sync.RootModelBuilder
import com.hmxpanel.aiide.tooling.impl.sync.RootProjectModelBuilderParams
...
internal class ToolingApiServerImpl(private val project: ProjectImpl) :
  ...
  override fun shutdown(): CompletableFuture<Void> {
    return CompletableFuture.supplyAsync {
      ...
      // see com.hmxpanel.aiide.tooling.impl.Main.main(String[])
