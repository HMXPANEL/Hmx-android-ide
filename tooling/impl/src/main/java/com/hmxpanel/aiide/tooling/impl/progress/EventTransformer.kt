...
package com.hmxpanel.aiide.tooling.impl.progress

import com.hmxpanel.aiide.tooling.events.StatusEvent
import com.hmxpanel.aiide.tooling.events.configuration.ProjectConfigurationOperationResult.PluginApplicationResult
...
import com.hmxpanel.aiide.tooling.events.transform.TransformOperationDescriptor.SubjectDescriptor
import com.hmxpanel.aiide.tooling.events.transform.TransformOperationResult
...
import com.hmxpanel.aiide.tooling.model.PluginIdentifier
...
class EventTransformer {
  companion object {
    ...
    ): com.hmxpanel.aiide.tooling.events.OperationDescriptor? =
      when (descriptor) {
        null -> null
    ...
    ): com.hmxpanel.aiide.tooling.events.configuration.ProjectConfigurationProgressEvent =
      com.hmxpanel.aiide.tooling.events.configuration.ProjectConfigurationStartEvent(
    ...
    fun projectConfigurationFinish(
      ...
      com.hmxpanel.aiide.tooling.events.configuration.ProjectConfigurationFinishEvent(
        displayName = event.displayName,
        eventTime = event.eventTime,
        descriptor = projectConfigurationDescriptor(event.descriptor),
    ...
    ): com.hmxpanel.aiide.tooling.events.configuration.ProjectConfigurationOperationResult =
      com.hmxpanel.aiide.tooling.events.configuration.ProjectConfigurationOperationResult(
    ...
    ): com.hmxpanel.aiide.tooling.events.configuration.ProjectConfigurationOperationDescriptor =
      com.hmxpanel.aiide.tooling.events.configuration.ProjectConfigurationOperationDescriptor(
    ...
    ): com.hmxpanel.aiide.tooling.model.ProjectIdentifier =
      com.hmxpanel.aiide.tooling.model.ProjectIdentifier(
        projectPath = project.projectPath,
        buildIdentifier =
          com.hmxpanel.aiide.tooling.model.BuildIdentifier(project.buildIdentifier.rootDir)
      )
    ...
    ): com.hmxpanel.aiide.tooling.events.download.FileDownloadResult =
      com.hmxpanel.aiide.tooling.events.download.FileDownloadResult(
    ...
    ): com.hmxpanel.aiide.tooling.events.download.FileDownloadOperationDescriptor =
      com.hmxpanel.aiide.tooling.events.download.FileDownloadOperationDescriptor(
        descriptor.uri,
        descriptor.name,
    ...
    private fun taskResult(
    ...
    ): com.hmxpanel.aiide.tooling.events.task.TaskOperationResult {

      // The order of conditions must not change here.

      if (result is TaskSuccessResult) {
        return com.hmxpanel.aiide.tooling.events.task.TaskSuccessResult(
          result.isUpToDate,
          result.isFromCache,
          result.startTime,
          result.endTime,
      ...
      if (result is TaskFailureResult) {
        return com.hmxpanel.aiide.tooling.events.task.TaskFailureResult(
          result.startTime,
          result.endTime
        )
      }
      ...
      if (result is TaskExecutionResult) {
        return com.hmxpanel.aiide.tooling.events.task.TaskExecutionResult(
          result.startTime,
          result.endTime,
          result.isIncremental,
          result.executionReasons
      ...
      if (result is TaskSkippedResult) {
        return com.hmxpanel.aiide.tooling.events.task.TaskSkippedResult(
          result.skipMessage,
          result.startTime,
          result.endTime
        )
      ...
      return com.hmxpanel.aiide.tooling.events.task.TaskOperationResult(
        startTime = result.startTime,
        endTime = result.endTime
      )
    }
    ...
    ): com.hmxpanel.aiide.tooling.events.task.TaskOperationDescriptor =
      com.hmxpanel.aiide.tooling.events.task.TaskOperationDescriptor(
        dependencies =
    ...
    ): com.hmxpanel.aiide.tooling.events.test.TestOperationDescriptor =
      com.hmxpanel.aiide.tooling.events.test.TestOperationDescriptor(
        name = descriptor.name,
        displayName = descriptor.displayName
      )
    ...
    ): com.hmxpanel.aiide.tooling.events.transform.TransformOperationDescriptor =
      com.hmxpanel.aiide.tooling.events.transform.TransformOperationDescriptor(
        name = descriptor.name,
        displayName = descriptor.displayName,
    ...
    ): com.hmxpanel.aiide.tooling.events.work.WorkItemOperationDescriptor =
      com.hmxpanel.aiide.tooling.events.work.WorkItemOperationDescriptor(
        name = descriptor.name,
        displayName = descriptor.displayName,
    ...
    // ----------------------- DEFAULT ----------------------------------
    fun progress(event: ProgressEvent): com.hmxpanel.aiide.tooling.events.ProgressEvent =
    ...
    ): com.hmxpanel.aiide.tooling.events.ProgressEvent =
      DefaultStartEvent(
        eventTime = event.eventTime,
        displayName = event.displayName,
        descriptor = operationDescriptor(event.descriptor)!!
