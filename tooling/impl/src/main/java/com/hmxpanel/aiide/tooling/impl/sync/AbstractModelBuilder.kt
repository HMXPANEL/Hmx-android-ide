...
import com.hmxpanel.aiide.builder.model.IDESyncIssue
...
import com.hmxpanel.aiide.utils.AndroidPluginVersion.Companion.MINIMUM_SUPPORTED
import com.hmxpanel.aiide.utils.ILogger
import com.hmxpanel.aiide.utils.LogUtils
...
abstract class AbstractModelBuilder<P, R>(
  ...
  companion object {
     ...
     * [ generateMessage(Object...)][com.hmxpanel.aiide.utils.ILogger.generateMessage] in [ILogger][com.hmxpanel.aiide.utils.ILogger].
     *
