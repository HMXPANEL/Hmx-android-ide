...
package com.hmxpanel.aiide.tooling.api.models.result

/**
 * Result sent to the client when selecting a project in [IProjectQueries][com.hmxpanel.aiide.tooling.api.IProjectQueries].
 *
