...
package com.hmxpanel.aiide.gradle

import com.hmxpanel.aiide.buildinfo.BuildInfo
import com.hmxpanel.aiide.tooling.api.LogSenderConfig._PROPERTY_IS_TEST_ENV
import com.hmxpanel.aiide.tooling.api.LogSenderConfig._PROPERTY_MAVEN_LOCAL_REPOSITORY
...
internal fun writeInitScript(file: File, deps: List<File>) {
  ...
  file.bufferedWriter().use {
    it.write(
      ...
      apply plugin: com.hmxpanel.aiide.gradle.AndroidIDEInitScriptPlugin
    """.trimIndent()
    )
  }
}
