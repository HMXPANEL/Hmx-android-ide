...
import com.hmxpanel.aiide.app.IDEApplication
import com.hmxpanel.aiide.databinding.LayoutOnboardingStatisticsBinding
...
class StatisticsFragment : OnboardingFragment() {
  ...
  fun updateStatOptInStatus() {
    com.hmxpanel.aiide.preferences.internal.StatPreferences.statOptIn =
