...
package com.hmxpanel.aiide.actions.filetree
...
import com.hmxpanel.aiide.adapters.viewholders.FileTreeViewHolder
import com.hmxpanel.aiide.eventbus.events.file.FileRenameEvent
import com.hmxpanel.aiide.preferences.databinding.LayoutDialogTextInputBinding
import com.hmxpanel.aiide.projects.FileManager
import com.hmxpanel.aiide.tasks.launchAsyncWithProgress
import com.hmxpanel.aiide.utils.DialogUtils
import com.hmxpanel.aiide.utils.FlashType
import com.hmxpanel.aiide.utils.flashMessage
...
class RenameAction(context: Context, override val order: Int) :
  ...
  override suspend fun execAction(data: ActionData) {
    ...
    binding.name.editText!!.hint =
      context.getString(com.hmxpanel.aiide.resources.R.string.new_name)
    binding.name.editText!!.setText(file.name)
    builder.setTitle(com.hmxpanel.aiide.resources.R.string.rename_file)
    builder.setMessage(com.hmxpanel.aiide.resources.R.string.msg_rename_file)
    builder.setView(binding.root)
    builder.setNegativeButton(android.R.string.cancel, null)
    builder.setPositiveButton(com.hmxpanel.aiide.resources.R.string.rename_file) {
      dialogInterface,
      _ ->
      dialogInterface.dismiss()
      actionScope.launchAsyncWithProgress(
          configureFlashbar = { builder, cancelChecker ->
            builder.message(com.hmxpanel.aiide.resources.R.string.please_wait)
          },
          action = { _, _ ->
            ...
            withContext(Dispatchers.Main) {
              flashMessage(
                  if (renamed) com.hmxpanel.aiide.resources.R.string.renamed
                  else com.hmxpanel.aiide.resources.R.string.rename_failed,
