...
package com.hmxpanel.aiide.activities.editor
...
import com.hmxpanel.aiide.databinding.LayoutSearchProjectBinding
import com.hmxpanel.aiide.flashbar.Flashbar
import com.hmxpanel.aiide.fragments.sheets.ProgressSheet
import com.hmxpanel.aiide.handlers.EditorBuildEventListener
import com.hmxpanel.aiide.handlers.LspHandler.connectClient
import com.hmxpanel.aiide.handlers.LspHandler.destroyLanguageServers
import com.hmxpanel.aiide.lookup.Lookup
import com.hmxpanel.aiide.lsp.IDELanguageClientImpl
import com.hmxpanel.aiide.lsp.java.utils.CancelChecker
import com.hmxpanel.aiide.preferences.internal.GeneralPreferences
import com.hmxpanel.aiide.projects.GradleProject
import com.hmxpanel.aiide.projects.builder.BuildService
import com.hmxpanel.aiide.projects.internal.ProjectManagerImpl
import com.hmxpanel.aiide.services.builder.GradleBuildService
import com.hmxpanel.aiide.services.builder.GradleBuildServiceConnnection
import com.hmxpanel.aiide.services.builder.gradleDistributionParams
import com.hmxpanel.aiide.tasks.executeAsyncProvideError
import com.hmxpanel.aiide.tasks.executeWithProgress
import com.hmxpanel.aiide.tooling.api.messages.AndroidInitializationParams
...
import com.hmxpanel.aiide.tooling.api.models.BuildVariantInfo
import com.hmxpanel.aiide.tooling.api.models.mapToSelectedVariants
import com.hmxpanel.aiide.utils.DURATION_INDEFINITE
import com.hmxpanel.aiide.utils.DialogUtils.newMaterialDialogBuilder
import com.hmxpanel.aiide.utils.RecursiveFileSearcher
import com.hmxpanel.aiide.utils.flashError
import com.hmxpanel.aiide.utils.flashbarBuilder
import com.hmxpanel.aiide.utils.resolveAttr
import com.hmxpanel.aiide.utils.showOnUiThread
import com.hmxpanel.aiide.utils.withIcon
import com.hmxpanel.aiide.viewmodel.BuildVariantsViewModel
  ...
  fun initializeProject(buildVariantsProvider: () -> Map<String, String>) {
    executeWithProgress { progress ->
      executeAsyncProvideError(buildVariantsProvider::invoke) { result, error ->
        com.hmxpanel.aiide.tasks.runOnUiThread {
          progress.dismiss()
        }
