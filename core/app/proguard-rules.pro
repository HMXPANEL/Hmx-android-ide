...
# Tooling API classes
-keep class com.hmxpanel.aiide.tooling.** { *; }

# Builder model implementations
-keep class com.hmxpanel.aiide.builder.model.** { *; }
...
-keep class com.hmxpanel.aiide.projects.util.StringSearch {
    packageName(java.nio.file.Path);
}
-keep class * implements org.antlr.v4.runtime.Lexer {
    <init>(...);
}
-keep class * extends com.hmxpanel.aiide.lsp.java.providers.completion.IJavaCompletionProvider {
    <init>(...);
}
-keep class com.hmxpanel.aiide.editor.api.IEditor { *; }
-keep class * extends com.hmxpanel.aiide.inflater.IViewAdapter { *; }
-keep class * extends com.hmxpanel.aiide.inflater.drawable.IDrawableParser {
    <init>(...);
    android.graphics.drawable.Drawable parse();
    android.graphics.drawable.Drawable parseDrawable();
}
-keep class com.hmxpanel.aiide.utils.DialogUtils {  public <methods>; }

# APK Metadata
-keep class com.hmxpanel.aiide.models.ApkMetadata { *; }
-keep class com.hmxpanel.aiide.models.ArtifactType { *; }
-keep class com.hmxpanel.aiide.models.MetadataElement { *; }
...
-keep enum com.hmxpanel.aiide.xml.permissions.Permission { *; }
...
-keep class com.hmxpanel.aiide.treesitter.** { *; }
...
# Stat uploader
-keep class com.hmxpanel.aiide.stats.** { *; }
...
## Themes
-keep enum com.hmxpanel.aiide.ui.themes.IDETheme {
  *;
}

## Contributor models - deserialized with GSON
-keep class * implements com.hmxpanel.aiide.contributors.Contributor {
  *;
}
