...
package com.hmxpanel.aiide.lsp.internal.model
...
private constructor(
  ...
  val result: com.hmxpanel.aiide.lsp.models.CompletionResult
) {
  ...
  companion object {
    ...
    val EMPTY =
      cache(
        CompletionParams(
          com.hmxpanel.aiide.models.Position.NONE,
          Paths.get(""), ICancelChecker.CANCELLED
        ),
        com.hmxpanel.aiide.lsp.models.CompletionResult.EMPTY
      )
    ...
    fun cache(
      ...
      result: com.hmxpanel.aiide.lsp.models.CompletionResult
    ): CachedCompletion {
      val params =
