...
/**
 * A Gradle project model which is identical to [IGradleProject][com.hmxpanel.aiide.tooling.api.IGradleProject]. This project module caches all the data
 * from an [IGradleProject][com.hmxpanel.aiide.tooling.api.IGradleProject] eliminating the use of [CompletableFuture] s.
 *
