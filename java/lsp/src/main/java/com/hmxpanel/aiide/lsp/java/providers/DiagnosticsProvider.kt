...
import com.hmxpanel.aiide.lsp.java.models.DiagnosticCode
import com.hmxpanel.aiide.lsp.java.models.DiagnosticCode.EMPTY_BLOCK
import com.hmxpanel.aiide.lsp.java.models.DiagnosticCode.UNUSED_THROWS
import com.hmxpanel.aiide.lsp.java.visitors.DiagnosticVisitor
import com.hmxpanel.aiide.lsp.models.DiagnosticItem
import com.hmxpanel.aiide.lsp.models.DiagnosticSeverity
import com.hmxpanel.aiide.lsp.models.DiagnosticSeverity.WARNING
...
import com.hmxpanel.aiide.utils.DocumentUtils.isSameFile
...
object DiagnosticsProvider {
  ...
  private fun getPosition(position: Long, lines: LineMap): com.hmxpanel.aiide.models.Position {
    abortIfCancelled()
    ...
    return com.hmxpanel.aiide.models.Position(line, column)
  }
