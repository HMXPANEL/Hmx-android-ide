...
import com.hmxpanel.aiide.lsp.java.rewrite.ConvertVariableToStatement
import com.hmxpanel.aiide.lsp.java.utils.CodeActionUtils.findPosition
...
class VariableToStatementAction : BaseJavaCodeAction() {
  ...
  override fun prepare(data: ActionData) {
    ...
    if (!data.hasRequiredData(com.hmxpanel.aiide.lsp.models.DiagnosticItem::class.java)) {
      markInvisible()
      return
    }

    val diagnostic = data.get(com.hmxpanel.aiide.lsp.models.DiagnosticItem::class.java)!!
  ...
  override suspend fun execAction(data: ActionData): Any {
    val diagnostic = data[com.hmxpanel.aiide.lsp.models.DiagnosticItem::class.java]!!
    val compiler =
