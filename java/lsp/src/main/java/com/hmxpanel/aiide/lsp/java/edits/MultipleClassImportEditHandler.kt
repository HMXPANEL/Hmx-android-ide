...
package com.hmxpanel.aiide.lsp.java.edits
...
class MultipleClassImportEditHandler(
  ...
  override fun performEdits(
    ...
    editor: CodeEditor,
    completionItem: com.hmxpanel.aiide.lsp.models.CompletionItem
  ) {
    val edits = mutableListOf<com.hmxpanel.aiide.lsp.models.TextEdit>()
    ...
    com.hmxpanel.aiide.lsp.util.RewriteHelper.performEdits(edits, editor)
  }
}
