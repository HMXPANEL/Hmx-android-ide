...
import com.hmxpanel.aiide.lsp.java.rewrite.RemoveException
import com.hmxpanel.aiide.lsp.java.utils.CodeActionUtils
...
class RemoveUnusedThrowsAction : BaseJavaCodeAction() {
  ...
  override fun prepare(data: ActionData) {
    ...
    if (
      !visible ||
      !data.hasRequiredData(com.hmxpanel.aiide.lsp.models.DiagnosticItem::class.java)
    ) {
      markInvisible()
      return
    }
  ...
  override suspend fun execAction(data: ActionData): Any {
    val d = data[com.hmxpanel.aiide.lsp.models.DiagnosticItem::class.java]!!
    val compiler =
