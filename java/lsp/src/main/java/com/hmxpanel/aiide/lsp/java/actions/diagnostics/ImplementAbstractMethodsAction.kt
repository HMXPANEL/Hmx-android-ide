...
import com.hmxpanel.aiide.javac.services.util.JavaDiagnosticUtils
import com.hmxpanel.aiide.lsp.java.actions.BaseJavaCodeAction
import com.hmxpanel.aiide.lsp.java.models.DiagnosticCode
import com.hmxpanel.aiide.lsp.java.rewrite.ImplementAbstractMethods
  ...
  override suspend fun execAction(data: ActionData): Any {
    val diagnostic =
      JavaDiagnosticUtils.asJCDiagnostic(
        data.get(
          com.hmxpanel.aiide.lsp.models.DiagnosticItem::class.java)!!.extra as Diagnostic<out JavaFileObject>
      )
