...
import com.hmxpanel.aiide.lsp.java.providers.CompletionProvider.MAX_COMPLETION_ITEMS
import com.hmxpanel.aiide.lsp.models.CompletionItem
import com.hmxpanel.aiide.lsp.models.CompletionResult
import com.hmxpanel.aiide.lsp.models.MatchLevel.CASE_SENSITIVE_EQUAL
...
import com.hmxpanel.aiide.utils.ClassTrie
import com.hmxpanel.aiide.utils.ClassTrie.Node
...
class ImportCompletionProvider(
   ...
   */
  private fun collectPackageNode(trie: com.hmxpanel.aiide.utils.ClassTrie, pkgName: String): Node? {
