package com.hmxpanel.aiide.lsp.java.actions.common
...
import com.hmxpanel.aiide.actions.requireEditor
...
class OrganizeImportsAction : BaseJavaCodeAction() {
  ...
  override suspend fun execAction(data: ActionData): Any {
    val watch = com.hmxpanel.aiide.utils.StopWatch("Organize imports")
    return try {
