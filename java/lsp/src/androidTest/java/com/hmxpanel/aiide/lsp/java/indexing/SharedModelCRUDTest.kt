...
package com.hmxpanel.aiide.lsp.java.indexing

import androidx.test.ext.junit.runners.AndroidJUnit4
import com.google.common.truth.Truth.assertThat
import com.hmxpanel.aiide.indexing.core.platform.ApiInfo
import com.hmxpanel.aiide.lsp.java.indexing.classfile.ArrayAnnotationElementValue
import com.hmxpanel.aiide.lsp.java.indexing.classfile.ClassAnnotationElementValue
import com.hmxpanel.aiide.lsp.java.indexing.classfile.EnumAnnotationElementValue
import com.hmxpanel.aiide.lsp.java.indexing.classfile.IAnnotationElementValue
import com.hmxpanel.aiide.lsp.java.indexing.classfile.JavaConstant
import com.hmxpanel.aiide.lsp.java.utils.JavaType
import com.hmxpanel.aiide.lsp.java.indexing.classfile.PrimitiveAnnotationElementValue
import com.hmxpanel.aiide.testing.android.rules.RealmDBTestRule
...
class SharedModelCRUDTest {
  ...
  fun testApiInfoCreate() {
    dbTestRule.withDb("api-info") {
      val apiInfo = com.hmxpanel.aiide.indexing.core.platform.ApiInfo.newInstance(since = 1, deprecatedIn = 21, removedIn = 23)
