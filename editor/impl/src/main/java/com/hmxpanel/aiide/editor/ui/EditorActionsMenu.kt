...
import com.hmxpanel.aiide.editor.R.layout
import com.hmxpanel.aiide.editor.databinding.LayoutPopupMenuItemBinding
import com.hmxpanel.aiide.editor.ui.EditorActionsMenu.ActionsListAdapter.VH
...
open class EditorActionsMenu(val editor: IDEEditor) :
  ...
  protected open fun onCreateActionData(): ActionData {
    ...
    data.put(com.hmxpanel.aiide.models.Range::class.java, editor.cursorLSPRange)
    data.put(
