...
import com.hmxpanel.aiide.lsp.util.DocumentationReferenceProvider
import com.hmxpanel.aiide.progress.ProgressManager
import com.hmxpanel.aiide.utils.KeyboardUtils
  ...
  override fun setLayout(layout: CompletionLayout) {
    ...
    (layout.completionList as? ListView)?.let {
      ...
      it.setOnItemLongClickListener { _, view, position, _ ->
        val data =
          (items[position] as? com.hmxpanel.aiide.lsp.models.CompletionItem)?.data
