...
package com.hmxpanel.aiide.lsp.xml.providers
...
import com.hmxpanel.aiide.lsp.api.AbstractServiceProvider
...
import com.hmxpanel.aiide.lsp.xml.providers.completion.AttrValueCompletionProvider
...
import com.hmxpanel.aiide.lsp.xml.providers.completion.common.CommonAttrCompletionProvider
import com.hmxpanel.aiide.lsp.xml.providers.completion.etc.InheritingAttrCompletionProvider
import com.hmxpanel.aiide.lsp.xml.providers.completion.layout.LayoutAttrCompletionProvider
import com.hmxpanel.aiide.lsp.xml.providers.completion.layout.LayoutTagCompletionProvider
import com.hmxpanel.aiide.lsp.xml.providers.completion.manifest.ManifestAttrCompletionProvider
import com.hmxpanel.aiide.lsp.xml.providers.completion.manifest.ManifestAttrValueCompletionProvider
import com.hmxpanel.aiide.lsp.xml.providers.completion.manifest.ManifestTagCompletionProvider
import com.hmxpanel.aiide.lsp.xml.utils.AnimTagTransformer
import com.hmxpanel.aiide.lsp.xml.utils.AnimatorTagTransformer
import com.hmxpanel.aiide.lsp.xml.utils.DrawableTagTransformer
import com.hmxpanel.aiide.lsp.xml.utils.ITagTransformer
import com.hmxpanel.aiide.lsp.xml.utils.MenuTagTransformer
import com.hmxpanel.aiide.lsp.xml.utils.NoOpTagTransformer
import com.hmxpanel.aiide.lsp.xml.utils.TransitionTagTransformer
import com.hmxpanel.aiide.lsp.xml.utils.XmlUtils
import com.hmxpanel.aiide.lsp.xml.utils.XmlUtils.NodeType
import com.hmxpanel.aiide.lsp.xml.utils.XmlUtils.NodeType.ATTRIBUTE
import com.hmxpanel.aiide.lsp.xml.utils.XmlUtils.NodeType.ATTRIBUTE_VALUE
import com.hmxpanel.aiide.lsp.xml.utils.XmlUtils.NodeType.TAG
import com.hmxpanel.aiide.lsp.xml.utils.XmlUtils.NodeType.UNKNOWN
import com.hmxpanel.aiide.lsp.xml.utils.forTransitionAttr
import com.hmxpanel.aiide.utils.CharSequenceReader
