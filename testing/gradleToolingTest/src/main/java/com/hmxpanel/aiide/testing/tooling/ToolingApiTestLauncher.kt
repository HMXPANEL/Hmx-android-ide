...
package com.hmxpanel.aiide.testing.tooling

import ch.qos.logback.core.CoreConstants
import com.hmxpanel.aiide.testing.tooling.models.ToolingApiTestLauncherParams
import com.hmxpanel.aiide.testing.tooling.models.ToolingApiTestScope
...
import com.hmxpanel.aiide.tooling.api.messages.toLogLine
import com.hmxpanel.aiide.tooling.api.util.ToolingApiLauncher
import com.hmxpanel.aiide.tooling.api.util.ToolingProps
import com.hmxpanel.aiide.tooling.events.ProgressEvent
import com.hmxpanel.aiide.utils.FileProvider
...
object ToolingApiTestLauncher {
  ...
  fun launchServerAsync(
    ...
    val androidHome = com.hmxpanel.aiide.testing.common.utils.findAndroidHome()
  ...
  private fun createProcessCmd(
    ...
    cmd.add(
      "-D${CoreConstants.STATUS_LISTENER_CLASS_KEY}=com.hmxpanel.aiide.tooling.impl.util.LogbackStatusListener")
